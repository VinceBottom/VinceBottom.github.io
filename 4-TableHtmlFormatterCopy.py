...
#os.remove("AllTable.html")##removefile
f = open("AllTable.html", "w")
f.write('<link rel="stylesheet" href="AllTableStyles.css">' + '\n')
f.write('<script type="text/javascript" src="AllTableScript.js"></script>' + '\n')
f.write('<table id="AllTable">' + '\n')
